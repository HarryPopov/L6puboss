...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2024 at 07:33 PM
...
(101, 'asdasdasdas', 'Norm', 10, 36),
(102, 'Tere', 'Väga viis', 10, 36),
(103, 'asd', 'asd', 6, 36),
(104, 'Täitsa hea resto ', 'Täiega hea resto', 8, 36),
(105, 'Normaalne jah', 'asdasd', 6, 36),
(106, 'Taavi', 'Hea teenindus, pisut maitsetu toit.', 6, 71),
(107, 'Neeme', 'Võis rahule jääda', 8, 4),
(108, 'Toivo', 'Sõime jõime ja kokku lõime', 8, 54),
(109, 'asd', 'asd', 6, 43),
(110, 'asdasd', 'asd', 6, 43),
(111, 'test', 'testtest', 8, 43),
(112, 'asdasd', 'asd', 6, 71);
...
(4, 'Angelo Cavet', 'Židlochovice', 8, 1),
...
(43, 'Bard Girdlestone', 'Buga', 6.3333, 6),
...
(54, 'Bekki Bartelot', 'Al Mughayyir', 6.5, 2),
...
(71, 'Amberly Harcarse', 'Matviyivka', 6.25, 4),
